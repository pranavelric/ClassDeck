...
class CourseDetailsRepository @Inject constructor() {
    ...
    suspend fun addAnnouncement(announcements: Announcements): MutableLiveData<ResponseState<String?>> {
    ...
    suspend fun addAssignment(announcements: Assignments): MutableLiveData<ResponseState<String?>> {
        val courseMutableLiveData: MutableLiveData<ResponseState<String?>> =
            MutableLiveData()
