package com.classroom.classdeck.ui.profile.yoursCourses
...
import com.classroom.classdeck.databinding.FragmentYourCoursesBinding
...
class YourCoursesFragment : Fragment() {
    ...
    private lateinit var binding: FragmentYourCoursesBinding

    override fun onCreateView(
        inflater: LayoutInflater, container: ViewGroup?,
        savedInstanceState: Bundle?
    ): View? {
        binding = FragmentYourCoursesBinding.inflate(inflater, container, false)
        return binding.root
    }
